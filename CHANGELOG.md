...
- **Homepage founder bios: harmonise length + add Toby's Accelerator Solutions** (2026-06-17, B1): the two bios were visibly lopsided (Toby ~36 words / 3 lines vs Andy ~62 / 6). Lengthened Toby's by adding the strongest credibility fact we have on him — **founder & CEO of Accelerator Solutions, a 25-person business he's taking through its own AI transformation in real time** (per Offer Canon §6.5 / manifesto: "we're AI-native ourselves… Toby's other business, Accelerator Solutions"). Ties his bio straight to the AX value prop. Trimmed Andy's lightly. Now 53 vs 62 words (within a line); track-record pin keeps them bottom-aligned. **Note:** this surfaces Toby's CEO title — a deliberate founder choice that supersedes the 2026-06-13 "orgs-only, no titles" bio ruling. Framed as "Toby's own business", not asserting an AS↔AX corporate relationship (unconfirmed). Confirm the "25-person" descriptor at sign-off.
