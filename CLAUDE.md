...
**Last session:** 2026-06-14 — **Offer Canon established + every founder decision locked live — single source of truth for what AX sells** ([#57](https://github.com/andy-carroll/accelerator-x-website/issues/57)), now **sign-off-ready v0.5**. Root-caused #26 (offer was defined in 3 contradictory places); adopted the recovered design intent (**"Two Doors" model**) and worked all decisions live: coaching renamed + repriced (**1:1 Exec AI Fast Track Coaching** 6wk/£10k · **Leadership Team AI Activation** base £15k+£2k/head, max 12 · **Open Cohort AI Bootcamp** £3,500/place), Phase 0/cycle £5k/£20k, **all +VAT**, half-day workshop **retired**, Fractional Advisory **dropped from v2**, Talks & Events **POA**, **full money-back guarantee**, IP/procurement set. Added an outcomes-first **"How to think about ROI" (§5.5)**, a **"make yes easy / no 12-month commitment"** principle, a **differentiation block** (vs automation agencies/consultancies), a **delivery model** (founders orchestrate + specialist networks — answers capacity/continuity), and a draft **§6.5 founders/origin** for About. Created `offer-canon.md` (v0.5) + `content/data/offerings.json`; archived 2 legacy offer docs; flagged stale specs/PRDs with pointers. A **4-persona adversarial pass** produced a 22-question FAQ/objection bank + §7.5 revisions. **Also:** production "outage" root-caused to **Sky Broadband Shield** (ISP filter), NOT DNS — site healthy globally throughout; corrected the prior "Hostinger parking IP" misdiagnosis (`90.207.238.183` = SKY-BROADBAND); reputation sweep clean (`dns-hosting.md`). **Deliberately deferred to ship v2:** measured client proof + 2–3 named founder AI builds. **Next:** Phase 5 — derive the live site from the Canon.
