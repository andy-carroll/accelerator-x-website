...
**Status as of 2026-07-13: all six B-ticket content-honesty walks closed.** B1–B9 all closed. **Only B10 (#75) — the flip — remains.** A separate architecture-review hardening batch (#78) also shipped and closed — CSP/HSTS, cache-header fix, money-path hardening (new GNG-1/Brevo failure alerts), unit tests, CSS bundling. No open `blocking`-labelled issue remains in the milestone except B10 itself.

**The 10 batch tickets (under "v2 Cutover" milestone, `launch-batch` label):**
- **B1** [#76](https://github.com/andy-carroll/accelerator-x-website/issues/76) Homepage — **closed 2026-07-09** · **B2** [#67](https://github.com/andy-carroll/accelerator-x-website/issues/67) Door 1 — **closed 2026-07-09** · **B3** [#68](https://github.com/andy-carroll/accelerator-x-website/issues/68) Door 2 — **closed 2026-07-11** · **B4** [#69](https://github.com/andy-carroll/accelerator-x-website/issues/69) How We Work + About — **closed 2026-07-11** · **B5** [#70](https://github.com/andy-carroll/accelerator-x-website/issues/70) Contact + FAQ + Talks — **closed 2026-07-13** · **B6** [#71](https://github.com/andy-carroll/accelerator-x-website/issues/71) Global furniture — **closed 2026-07-13**
- Gates (all closed): **B7** [#72](https://github.com/andy-carroll/accelerator-x-website/issues/72) · **B8** [#73](https://github.com/andy-carroll/accelerator-x-website/issues/73) · **B9** [#74](https://github.com/andy-carroll/accelerator-x-website/issues/74) · **B10** [#75](https://github.com/andy-carroll/accelerator-x-website/issues/75) — the flip, in progress 2026-07-13
...
**Start here: [B10 — the flip (#75)](https://github.com/andy-carroll/accelerator-x-website/issues/75)** — all six B-ticket content walks are closed; this is the last thing standing between `rebuild/v2` and production. Carried, not blocking: the site-wide title-separator em-dashes ("Page — Accelerator X" in `<title>`/`og:title`/`twitter:title`/JSON-LD names) were deliberately deferred across every B-ticket to a final pass — Andy's call whether that happens before or after this cutover. #83 remains queued whenever engineering-only work resumes.
