...
next_article_title: "Building the AI-Native Team"
---
...
We are moving from a paradigm of _conversational AI_ (where you chat with a bot in a single window) to a paradigm of _agentic workflows_ (where multiple AI agents collaborate to execute a multi-step process autonomously).
